...
from properties import ARCHIVE_THRESHOLD, EXPECTED_LABEL, RESULTS_PATH
...
class Archive:
    ...
    def create_report(self, x_test, seeds, generation):
        ...
        print(self.archived_seeds)
        print(seeds)
        print(len(self.archived_seeds))
        print(len(seeds))
